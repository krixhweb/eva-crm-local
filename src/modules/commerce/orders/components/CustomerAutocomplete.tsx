...
export const CustomerAutocomplete: React.FC<CustomerAutocompleteProps> = ({
  ...
  // Sync input value when external value changes or resets
  useEffect(() => {
    if (value) {
        ...
        // If value is cleared externally, allow input to be cleared or keep as is if typing
        // Here we clear it if we are not focused to ensure reset works
